...
class NetWorthInput extends React.Component {
   ...
   // This method is which delegates state change to a higher level component
   // The higher level component is: <MillionaireCalculator />
   handleChange = (e) => {
      ...
      return (
         <div className="contents">
            <NetWorthInput
               currency="d"
               networth={dollars}
               onNetWorthChange={this.handleDollerChange} />
            <NetWorthInput
               currency="r"
               networth={rupees}
